...
/*   Updated: 2025/10/09 14:37:17 by tsaby            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	load_textures(t_game *cube)
{
	...
	if (!cube->textures->NO_img.img_ptr || !cube->textures->SO_img.img_ptr || !cube->textures->EA_img.img_ptr || !cube->textures->WE_img.img_ptr)
		return (-1);
	return(0);
}
