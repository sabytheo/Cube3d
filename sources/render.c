...
/*   Updated: 2025/11/04 17:58:55 by egache           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 			{
// 				if (y == (int)cube->player->pos_y
// 					&& x == (int)cube->player->pos_x)
// 				{
// 					draw_x = tile_width * (int)cube->player->pos_x + (tile_width
// 							* (cube->player->pos_x
// 								- floor(cube->player->pos_x)));
// 					draw_y = tile_width * (int)cube->player->pos_y + (tile_width
// 							* (cube->player->pos_y
// 								- floor(cube->player->pos_y)));
// 					img_pixel_put(img, ceil(draw_x), ceil(draw_y), get_color(0,
// 							0, 255));
// 					offset_pos = 1;
// 					while (offset_pos <= 5)
// 					{
...
// 									- offset_pos * sin(cube->player->angle
// 										+ M_PI) - offset_sin_cos
// 									* sin(cube->player->angle + M_PI + M_PI_2)),
// 								get_color(255, 255, 0));
// 							img_pixel_put(img, (int)(draw_x + offset_pos
// 									* cos(cube->player->angle + M_PI)
// 									- offset_sin_cos * cos(cube->player->angle
...
// 									{
// 										img_pixel_put(img, offset_x + step_x,
// 											offset_y + step_y, get_color(255,
// 												255, 255));
// 										step_y++;
// 									}
// 									step_x++;
...
void	raycast(t_game *cube, t_raycast *raycast)
{
	...
	while (x <= WIDTH)
	{
		...
		{
			cube->textures.y = cube->textures.EA_img.ht
				/ cube->raycast->wall_height;
